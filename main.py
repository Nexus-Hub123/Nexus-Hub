...
modal_para = """
        Join the ultimate battle and prove your skills in this thrilling tournament with exciting cash prizes! The tournament features Mobile Legends in a Squad vs Squad format, with a registration fee of ₹300 per squad and the first winning prize will be ₹1400 and second prize will be ₹700 (paid via GPay). The registration is open now, it will close on 17th March. Matches will be held online, allowing players to compete from home. The knockout format includes 8 squads battling in three rounds, with the match starting at 04:00PM on 18th March. Prize money will be transferred to the winner's GPay number, and further details will be shared via WhatsApp upon registration. Are you ready for the challenge? Register now and dominate the battlefield!
"""
